...
(function() {
  ...
  Getopt = (function() {
    ...
    function Getopt(optionsPattern) {
      var comment, definition, fixed_long_name, has_argument, long_name, multi_supported, name, option, optional, short_name, _i, _len, _ref;
    ...
    Getopt.prototype.parse = function(argv) {
      var arg, e, i, long_name, option, rt_argv, rt_options, short_name, short_names, value, _i, _j, _len, _len1, _ref, _ref1;
      try {
        argv = argv.slice(0);
        rt_options = {};
        rt_argv = [];
