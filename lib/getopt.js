...
(function() {
  ...
  Getopt = (function() {
    ...
    function Getopt(options) {
      var comment, has_argument, info, long_name, multi_supported, name, option, short_name, _i, _len, _ref, _ref1;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (typeof has_argument === 'string') {
          info = has_argument;
          (__matches = info.match(/^(.*?)(?:#(.*))?$/));
          comment = (_ref1 = __matches[2]) != null ? _ref1 : '';
          info = __matches[1];
    ...
    Getopt.prototype.getHelp = function() {
      var comment, long_name, opt, option, options, short_name, strs, ws, _i, _len, _ref;
      ws = [];
      options = [];
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        long_name = _ref[_i];
        option = this.long_options[long_name];
        short_name = option.short_name, long_name = option.long_name, comment = option.comment;
