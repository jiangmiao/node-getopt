...
(function() {
  ...
  Getopt = (function() {
    ...
    Getopt.prototype.trigger_events_ = function(opt) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (options[name] != null) {
          this.events[name].call(this, opt.argv, opt.options);
        }
      }
      return this;
    };
    ...
    Getopt.prototype.parse = function(argv) {
      var arg, i, long_name, opt, option, rt_argv, rt_options, short_name, short_names, value, _i, _len;
      argv = argv.slice(0);
      rt_options = {};
      rt_argv = [];
      ...
      this.parsedOptions = opt;
      this.trigger_events_(opt);
      return opt;
    };
